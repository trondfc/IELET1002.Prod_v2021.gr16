 ...
 * The string can be up to 18 siffers
...
String test_string = "62122751200";                                     // Creating the input number (can be up to 18 siffers)
...
void setup(){
    ...
    Serial.println("converting a string to an array of numbers:");      // Print info line
    Serial.print("    input number is : ");                             // Print info text
    Serial.println(test_string);                                        // Print input number
    int *r;                                                             // Create an int array for the return
    r = Convert.s_to_array(test_string,char_lenght);                    // Run the function using the test number and the posittion array
