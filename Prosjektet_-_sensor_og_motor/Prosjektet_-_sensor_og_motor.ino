...
long interval_manuel = 120000;          // Tid mellom hver gang signalet for manuel styring leses.
long interval_temp_cot = 600000;        // Tid mellom hver gang temperatur signalet skal leses.
long interval_temp_1 = 30000;          // Tid mellom hver gang sensorverdier skal leses.
long interval_temp_2 = 600000;         // Tid mellom hver gang snitt fra sensormålinger skal regnes ut.
...
void loop() {
  ...
  if (override_state == 2) {                            // Om override = 2 kjøres automatisk temperatur styring.
    ...
    else {                   // Om det er varmere enn ønsket skrus ovn av. 
      Serial.print("--------------");
      Serial.println("vindu");
      ovn = 0;
